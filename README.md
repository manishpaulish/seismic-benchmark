...
2. 2. **PINNs fail at every frequency** - spectral bias causes IC loss to stagnate at 0.76, producing slowdowns of 1814x to 2909x and amplitude errors exceeding 26000x relative to FD.
   3. 3. **FNO works at low frequencies** - achieves 0.91% L2 error at 5Hz and 1.79% at 10Hz on homogeneous media.
      4. 4. **FNO fails above 10Hz due to amplitude degeneracy** - a previously undocumented failure mode where near-uniform wavefield amplitudes flatten the MSE loss surface.
         5. 5. **FNO degrades on layered media** - L2 error increases 36-fold at 5Hz and fails completely at 10Hz, even with model-specific retraining.
           
            6. ## Results Summary
           
            7. | Method | 5Hz | 10Hz | 20Hz | 40Hz | 80Hz |
            8. | :--- | :---: | :---: | :---: | :---: | :---: |
            9. | FD | under 25ms | under 25ms | under 25ms | under 25ms | under 25ms |
            10. | FNO homogeneous | 0.91% L2 | 1.79% L2 | FAIL | FAIL | FAIL |
            11. | FNO layered | 32.4% L2 | FAIL | - | - | - |
            12. | PINN | 2132x | 1814x | 1829x | 2178x | 2909x |
